...
// The same wiring kinetis/framework's own fixture uses: the adapter
// delivers a raw request, and RequestBodyMiddleware — which a real
// application reaches through the Kernel's global pipeline — is what
// bounds and parses its body.
